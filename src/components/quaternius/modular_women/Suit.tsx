  ...
  return (
    <group {...props} dispose={null}>
      ...
      <group rotation={[-Math.PI / 2, 0, 0]} scale={100}>
        ...
        <skinnedMesh geometry={nodes.Suit_Body_3.geometry} material={materials.Skin} skeleton={nodes.Suit_Body_3.skeleton} />
      </group>
      <group rotation={[-Math.PI / 2, 0, 0]} scale={100}>
      ...
      <group rotation={[-Math.PI / 2, 0, 0]} scale={100}>
        ...
        <skinnedMesh geometry={nodes.Suit_Head_2.geometry} material={materials.Hair_Blond} skeleton={nodes.Suit_Head_2.skeleton} />
        <skinnedMesh geometry={nodes.Suit_Head_3.geometry} material={materials.Hair_Brown} skeleton={nodes.Suit_Head_3.skeleton} />
        <skinnedMesh geometry={nodes.Suit_Head_4.geometry} material={materials.Brown} skeleton={nodes.Suit_Head_4.skeleton} />
      </group>
