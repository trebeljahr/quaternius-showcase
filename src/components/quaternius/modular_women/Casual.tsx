...
export function Model(props: JSX.IntrinsicElements['group']) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <group rotation={[-Math.PI / 2, 0, 0]} scale={100}>
        <skinnedMesh geometry={nodes.Casual_Body_1.geometry} material={materials.White} skeleton={nodes.Casual_Body_1.skeleton} />
      ...
      <group rotation={[-Math.PI / 2, 0, 0]} scale={100}>
        ...
        <skinnedMesh geometry={nodes.Casual_Head_2.geometry} material={materials.Hair_Blond} skeleton={nodes.Casual_Head_2.skeleton} />
        <skinnedMesh geometry={nodes.Casual_Head_3.geometry} material={materials.Hair_Brown} skeleton={nodes.Casual_Head_3.skeleton} />
        <skinnedMesh geometry={nodes.Casual_Head_4.geometry} material={materials.Brown} skeleton={nodes.Casual_Head_4.skeleton} />
      </group>
