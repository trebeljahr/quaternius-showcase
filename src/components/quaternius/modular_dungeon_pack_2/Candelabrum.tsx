...
export default function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/glb/modular_dungeon_pack/Candelabrum.glb') as unknown as GLTFResult
  return (
...
useGLTF.preload('/glb/modular_dungeon_pack/Candelabrum.glb')
