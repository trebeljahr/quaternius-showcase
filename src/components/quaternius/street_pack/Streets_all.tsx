  ...
  return (
    <group {...props} dispose={null}>
      ...
      <group position={[2.84, 0, -3]} rotation={[-Math.PI / 2, 0, 0]} scale={100}>
        ...
        <mesh
          geometry={nodes.Street_Ramp_Bridge001_4.geometry}
      ...
      <group position={[0, 0, -2]} rotation={[-Math.PI / 2, 0, -Math.PI]} scale={100}>
        ...
        <mesh
          geometry={nodes.Street_Ramp_Water000_5.geometry}
          material={materials["Material.003"]}
        />
      </group>
      <group position={[-5.78, 0, -5.89]} rotation={[-Math.PI / 2, 0, 0]} scale={100}>
        ...
        <mesh
          geometry={nodes.Street_Ramp_Water001_5.geometry}
          material={materials["Material.003"]}
        />
      </group>
      ...
      <group position={[0, 0, -3]} rotation={[-Math.PI / 2, 0, 0]} scale={100}>
        ...
        <mesh
          geometry={nodes.Street_Bridge_Underpass_4.geometry}
          material={materials["Material.003"]}
        />
      </group>
      <group position={[-3, 0, -3]} rotation={[-Math.PI / 2, 0, 0]} scale={100}>
        ...
        <mesh
          geometry={nodes.Street_Bridge_Water_5.geometry}
          material={materials["Material.003"]}
        />
      </group>
...
useGLTF.preload("/glb/street_pack/Streets_all.glb");
