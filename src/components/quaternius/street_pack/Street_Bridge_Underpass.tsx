...
export default function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/glb/street_pack/Street_Bridge_Underpass.glb') as unknown as GLTFResult
  return (
...
useGLTF.preload('/glb/street_pack/Street_Bridge_Underpass.glb')
