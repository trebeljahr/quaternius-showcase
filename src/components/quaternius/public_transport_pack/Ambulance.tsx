...
export function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/Ambulance.glb') as GLTFResult
  return (
    <group {...props} dispose={null}>
      <mesh geometry={nodes.BackWheels.geometry} material={materials.Material} position={[0, -0.13, -0.98]} rotation={[0, Math.PI / 2, 0]} scale={100} />
      <mesh geometry={nodes.FrontWheels.geometry} material={materials.Material} position={[0.99, -0.13, 2.69]} rotation={[0, Math.PI / 2, 0]} scale={100} />
