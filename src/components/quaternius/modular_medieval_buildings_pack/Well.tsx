...
export function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/glb/modular_medieval_buildings_pack/Well.glb') as unknown as GLTFResult
  return (
...
useGLTF.preload('/glb/modular_medieval_buildings_pack/Well.glb')
