      ...
      <group name="Root_Scene">
        <group name="RootNode">
          ...
          <group name="BlackLionFish" rotation={[-Math.PI / 2, 0, 0]} scale={100}>
            <skinnedMesh name="BlackLionFish_1" geometry={nodes.BlackLionFish_1.geometry} material={materials.Eyes} skeleton={nodes.BlackLionFish_1.skeleton} />
            <skinnedMesh name="BlackLionFish_2" geometry={nodes.BlackLionFish_2.geometry} material={materials.BlackLionFish_Dark} skeleton={nodes.BlackLionFish_2.skeleton} />
            <skinnedMesh name="BlackLionFish_3" geometry={nodes.BlackLionFish_3.geometry} material={materials.BlackLionFish_Main} skeleton={nodes.BlackLionFish_3.skeleton} />
            <skinnedMesh name="BlackLionFish_4" geometry={nodes.BlackLionFish_4.geometry} material={materials.BlackLionFish_Light} skeleton={nodes.BlackLionFish_4.skeleton} />
          </group>
        </group>
      </group>
    </group>
