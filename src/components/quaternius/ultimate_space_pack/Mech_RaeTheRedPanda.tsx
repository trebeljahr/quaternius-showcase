...
export function Model(props: JSX.IntrinsicElements['group']) {
  ...
  const { scene, animations } = useGLTF('/Mech_RaeTheRedPanda-transformed.glb')
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <skinnedMesh name="RaeTheRedPanda" geometry={nodes.RaeTheRedPanda.geometry} material={materials.Atlas} skeleton={nodes.RaeTheRedPanda.skeleton} />
      </group>
    </group>
  )
}

useGLTF.preload('/Mech_RaeTheRedPanda-transformed.glb')
