...
export function Model(props: JSX.IntrinsicElements['group']) {
  ...
  const { scene, animations } = useGLTF('/Mech_FinnTheFrog-transformed.glb')
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <skinnedMesh name="FinnTheFrog" geometry={nodes.FinnTheFrog.geometry} material={materials.Atlas} skeleton={nodes.FinnTheFrog.skeleton} />
      </group>
    </group>
  )
}

useGLTF.preload('/Mech_FinnTheFrog-transformed.glb')
