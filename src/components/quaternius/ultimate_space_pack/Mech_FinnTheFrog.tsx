...
export default function Model(props: JSX.IntrinsicElements['group']) {
  ...
  const { scene, animations } = useGLTF('/glb/ultimate_space_pack/Mech_FinnTheFrog-transformed.glb')
...
useGLTF.preload('/glb/ultimate_space_pack/Mech_FinnTheFrog-transformed.glb')
