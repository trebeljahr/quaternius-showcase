...
export function Model(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials, animations } = useGLTF('/glb/platformer_game_pack/Enemy.glb') as unknown as GLTFResult
        ...
        <group name='RootNode'>
          ...
          <group name='Enemy_Body' rotation={[-Math.PI / 2, 0, 0]} scale={100}>
            <skinnedMesh
              ...
              skeleton={nodes.Enemy_Body_1.skeleton}
            />
            <skinnedMesh
              name='Enemy_Body_2'
              geometry={nodes.Enemy_Body_2.geometry}
          ...
          <group name='Enemy_Face' rotation={[-Math.PI / 2, 0, 0]} scale={100}>
            <skinnedMesh
              ...
              material={materials.Main_Dark}
              skeleton={nodes.Enemy_Face_1.skeleton}
            />
            <skinnedMesh
              name='Enemy_Face_2'
              geometry={nodes.Enemy_Face_2.geometry}
              material={materials.Horns}
              skeleton={nodes.Enemy_Face_2.skeleton}
            />
            <skinnedMesh
              name='Enemy_Face_3'
              geometry={nodes.Enemy_Face_3.geometry}
              material={materials.Teeth}
              skeleton={nodes.Enemy_Face_3.skeleton}
            />
            <skinnedMesh
              name='Enemy_Face_4'
              geometry={nodes.Enemy_Face_4.geometry}
              material={materials.Tongue}
              skeleton={nodes.Enemy_Face_4.skeleton}
            />
          </group>
        </group>
      </group>
...
useGLTF.preload('/glb/platformer_game_pack/Enemy.glb')
