...
export default function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/glb/platformer_game_pack/Cube_Dirt_Side_Tall.glb') as unknown as GLTFResult
  return (
...
useGLTF.preload('/glb/platformer_game_pack/Cube_Dirt_Side_Tall.glb')
