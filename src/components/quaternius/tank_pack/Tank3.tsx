...
export default function Model(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials, animations } = useGLTF('/glb/tank_pack/Tank3.glb') as unknown as GLTFResult
      ...
      <group name='Root_Scene'>
        <group name='RootNode'>
          ...
          <mesh
            ...
            position={[-2.14, 5.22, 0]}
            rotation={[-Math.PI / 2, Math.PI / 2, 0]}
            scale={[45.48, 45.48, 632.27]}
          />
...
useGLTF.preload('/glb/tank_pack/Tank3.glb')
