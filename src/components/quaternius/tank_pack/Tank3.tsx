...
export function Model(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials, animations } = useGLTF('/Tank3.glb') as GLTFResult
    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Root_Scene">
        <group name="RootNode">
          ...
          <mesh name="Tank_Gun" geometry={nodes.Tank_Gun.geometry} material={materials.Main_Light} position={[-2.14, 5.22, 0]} rotation={[-Math.PI / 2, Math.PI / 2, 0]} scale={[45.48, 45.48, 632.27]} />
          <group name="Tank_Turret" position={[0, 4.57, 0]} rotation={[-Math.PI / 2, 0, 0]} scale={585.39}>
          ...
          <group name="Tank_body" position={[0, 1.3, -0.07]} rotation={[-Math.PI / 2, 0, 0]} scale={100}>
            ...
            <skinnedMesh name="Tank_body_2" geometry={nodes.Tank_body_2.geometry} material={materials.Main_Details} skeleton={nodes.Tank_body_2.skeleton} />
            <skinnedMesh name="Tank_body_3" geometry={nodes.Tank_body_3.geometry} material={materials.Wheels} skeleton={nodes.Tank_body_3.skeleton} />
            <skinnedMesh name="Tank_body_4" geometry={nodes.Tank_body_4.geometry} material={materials.Main} skeleton={nodes.Tank_body_4.skeleton} />
          </group>
