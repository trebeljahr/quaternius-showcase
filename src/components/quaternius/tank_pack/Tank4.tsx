    ...
    <group ref={group} {...props} dispose={null}>
      ...
      <group name="Root_Scene">
        <group name="RootNode">
          ...
          <group
            name="Tank_Gun"
            position={[1.37, 5.27, -0.07]}
            rotation={[-Math.PI / 2, 0, 0]}
            scale={100}
          >
            <mesh
              name="Tank_Gun_1"
              geometry={nodes.Tank_Gun_1.geometry}
              material={materials.Main}
            />
            <mesh
              name="Tank_Gun_2"
              geometry={nodes.Tank_Gun_2.geometry}
              material={materials.Main_Details}
            />
            <mesh
              name="Tank_Gun_3"
              geometry={nodes.Tank_Gun_3.geometry}
              material={materials.Main_Light}
            />
          </group>
          <group
            name="Tank_Turret"
            position={[1.47, 4.93, -0.07]}
            rotation={[-Math.PI / 2, 0, 0]}
            scale={100}
          >
            <mesh
