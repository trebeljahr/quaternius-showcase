...
export function Model(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials, animations } = useGLTF('/Tank4.glb') as GLTFResult
      ...
      <group name="Root_Scene">
        <group name="RootNode">
          ...
          <group name="Tank_body001" position={[0, 1.3, -0.07]} rotation={[-Math.PI / 2, 0, 0]} scale={100}>
            <skinnedMesh name="Tank_body001_1" geometry={nodes.Tank_body001_1.geometry} material={materials.Main_Details} skeleton={nodes.Tank_body001_1.skeleton} />
            <skinnedMesh name="Tank_body001_2" geometry={nodes.Tank_body001_2.geometry} material={materials.Main} skeleton={nodes.Tank_body001_2.skeleton} />
            <skinnedMesh name="Tank_body001_3" geometry={nodes.Tank_body001_3.geometry} material={materials.Main_Light} skeleton={nodes.Tank_body001_3.skeleton} />
            <skinnedMesh name="Tank_body001_4" geometry={nodes.Tank_body001_4.geometry} material={materials.Main_Dark} skeleton={nodes.Tank_body001_4.skeleton} />
            <skinnedMesh name="Tank_body001_5" geometry={nodes.Tank_body001_5.geometry} material={materials.Wheels} skeleton={nodes.Tank_body001_5.skeleton} />
          </group>
