    ...
    <group ref={group} {...props} dispose={null}>
      ...
      <group name="Root_Scene">
        <group name="RootNode">
          ...
          <group
            name="Tank_Turret"
            position={[1.55, 3.72, -0.04]}
            rotation={[-Math.PI / 2, 0, 0]}
            scale={100}
          >
            <mesh
              name="Tank_Turret_1"
              geometry={nodes.Tank_Turret_1.geometry}
              material={materials.Main}
            />
            <mesh
              name="Tank_Turret_2"
              geometry={nodes.Tank_Turret_2.geometry}
              material={materials.Main_Light}
            />
            <mesh
              name="Tank_Turret_3"
              geometry={nodes.Tank_Turret_3.geometry}
