...
export function Model(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials, animations } = useGLTF('/Tank2.glb') as GLTFResult
    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Root_Scene">
        <group name="RootNode">
          ...
          <group name="Tank_Turret" position={[0.37, 3.8, -0.04]} rotation={[-Math.PI / 2, 0, 0]} scale={[2117.49, 2415.08, 352.28]}>
          ...
          <mesh name="Tank_Gun" geometry={nodes.Tank_Gun.geometry} material={materials.Main_Details} position={[-2.79, 3.9, -0.07]} rotation={[-Math.PI / 2, 0, 0]} scale={100} />
