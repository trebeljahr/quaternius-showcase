...
export function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/glb/modular_sci_fi/LongWindow_Wall_SideB.glb') as unknown as GLTFResult
  return (
...
useGLTF.preload('/glb/modular_sci_fi/LongWindow_Wall_SideB.glb')
