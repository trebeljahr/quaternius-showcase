...
export default function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/glb/house_interior_pack/Houseplant_5.glb') as unknown as GLTFResult
  return (
...
useGLTF.preload('/glb/house_interior_pack/Houseplant_5.glb')
