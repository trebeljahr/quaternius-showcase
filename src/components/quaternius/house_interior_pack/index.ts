...
export const Bathroom_ToiletPaperPile = dynamic(() => import("./Bathroom_ToiletPaperPile"), {
  ssr: false,
});
export const Bathroom_Towel = dynamic(() => import("./Bathroom_Towel"), { ssr: false });
export const Bathroom_WashingMachine = dynamic(() => import("./Bathroom_WashingMachine"), {
  ssr: false,
});
