...
export function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/glb/medieval_weapons_pack/Shield_Heater.glb') as unknown as GLTFResult
  return (
...
useGLTF.preload('/glb/medieval_weapons_pack/Shield_Heater.glb')
