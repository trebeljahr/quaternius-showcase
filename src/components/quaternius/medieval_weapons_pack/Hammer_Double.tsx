...
export default function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/glb/medieval_weapons_pack/Hammer_Double.glb') as unknown as GLTFResult
  return (
...
useGLTF.preload('/glb/medieval_weapons_pack/Hammer_Double.glb')
