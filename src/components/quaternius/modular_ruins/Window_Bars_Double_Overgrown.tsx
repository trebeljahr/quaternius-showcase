...
export function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/glb/modular_ruins/Window_Bars_Double_Overgrown.glb') as unknown as GLTFResult
  return (
...
useGLTF.preload('/glb/modular_ruins/Window_Bars_Double_Overgrown.glb')
