...
type ActionName = 'Attacking_Idle' | 'Dagger_Attack' | 'Dagger_Attack2' | 'Death' | 'PickUp' | 'Punch' | 'RecieveHit' | 'RecieveHit_Attacking' | 'Roll' | 'Run' | 'Walk' | 'Idle' | 'CharacterArmature|Attacking_Idle' | 'CharacterArmature|Dagger_Attack' | 'CharacterArmature|Dagger_Attack2' | 'CharacterArmature|Death' | 'CharacterArmature|Idle' | 'CharacterArmature|PickUp' | 'CharacterArmature|Punch' | 'CharacterArmature|RecieveHit' | 'CharacterArmature|RecieveHit_Attacking' | 'CharacterArmature|Roll' | 'CharacterArmature|Run' | 'CharacterArmature|Walk'
type GLTFActions = Record<ActionName, THREE.AnimationAction>

export function Model(props: JSX.IntrinsicElements['group']) {
  const group = useRef<THREE.Group>()
  const { nodes, materials, animations } = useGLTF('/Character_Animated.glb') as GLTFResult
    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Root_Scene">
        <group name="RootNode">
          ...
          <skinnedMesh name="Rogue001" geometry={nodes.Rogue001.geometry} material={materials['Material.006']} skeleton={nodes.Rogue001.skeleton} position={[0, 0, 0.17]} rotation={[-Math.PI / 2, 0, 0]} scale={100} />
        </group>
      </group>
    </group>
  )
...
useGLTF.preload('/Character_Animated.glb')
