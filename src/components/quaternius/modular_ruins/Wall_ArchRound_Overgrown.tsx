...
export function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/glb/modular_ruins/Wall_ArchRound_Overgrown.glb') as unknown as GLTFResult
  return (
...
useGLTF.preload('/glb/modular_ruins/Wall_ArchRound_Overgrown.glb')
