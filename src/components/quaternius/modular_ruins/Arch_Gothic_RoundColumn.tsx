...
export default function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/glb/modular_ruins/Arch_Gothic_RoundColumn.glb') as unknown as GLTFResult
  return (
...
useGLTF.preload('/glb/modular_ruins/Arch_Gothic_RoundColumn.glb')
