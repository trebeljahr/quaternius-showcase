...
type GLTFResult = GLTF & {
  nodes: {
    Floor_Hole_Corner_1: THREE.Mesh
    Floor_Hole_Corner_2: THREE.Mesh
  }
  materials: {
...
export function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/glb/modular_ruins/Floor_Hole_Corner.glb') as unknown as GLTFResult
  return (
...
useGLTF.preload('/glb/modular_ruins/Floor_Hole_Corner.glb')
