...
type GLTFResult = GLTF & {
  nodes: {
    Floor_Squares_1: THREE.Mesh
    Floor_Squares_2: THREE.Mesh
  }
  materials: {
...
export default function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/glb/modular_ruins/Floor_Squares.glb') as unknown as GLTFResult
  return (
...
useGLTF.preload('/glb/modular_ruins/Floor_Squares.glb')
