...
type GLTFResult = GLTF & {
  nodes: {
    Floor_Diamond_1: THREE.Mesh
    Floor_Diamond_2: THREE.Mesh
  }
  materials: {
...
export default function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/glb/modular_ruins/Floor_Diamond.glb') as unknown as GLTFResult
  return (
...
useGLTF.preload('/glb/modular_ruins/Floor_Diamond.glb')
