...
export default function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/glb/modular_ruins/Wall_Double_Broken.glb') as unknown as GLTFResult
  return (
...
useGLTF.preload('/glb/modular_ruins/Wall_Double_Broken.glb')
