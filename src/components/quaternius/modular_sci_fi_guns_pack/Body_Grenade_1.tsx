...
export default function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/glb/modular_sci_fi_guns_pack/Body_Grenade_1.glb') as unknown as GLTFResult
  return (
...
useGLTF.preload('/glb/modular_sci_fi_guns_pack/Body_Grenade_1.glb')
