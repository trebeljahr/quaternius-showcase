...
export function Model(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials, animations } = useGLTF('/Mike.glb') as GLTFResult
    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Root_Scene">
        <group name="RootNode">
          ...
          <skinnedMesh name="Mike" geometry={nodes.Mike.geometry} material={materials.Mike_Texture} skeleton={nodes.Mike.skeleton} rotation={[-Math.PI / 2, 0, 0]} scale={100} />
        </group>
      </group>
    </group>
  )
