    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Root_Scene">
        <group name="RootNode">
          ...
          <skinnedMesh name="George" geometry={nodes.George.geometry} material={materials.George_Texture} skeleton={nodes.George.skeleton} rotation={[-Math.PI / 2, 0, 0]} scale={100} />
        </group>
      </group>
    </group>
  )
