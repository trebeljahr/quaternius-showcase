...
export function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/glb/PalmTree_4.glb') as unknown as GLTFResult
  return (
    <group {...props} dispose={null}>
      <group rotation={[-Math.PI / 2, 0, 0]} scale={100}>
        <mesh geometry={nodes.PalmTree_4_1.geometry} material={materials.Wood} />
        <mesh geometry={nodes.PalmTree_4_2.geometry} material={materials.Green_Tree} />
        <mesh geometry={nodes.PalmTree_4_3.geometry} material={materials.DarkGreen_Tree} />
...
useGLTF.preload('/PalmTree_4.glb')
