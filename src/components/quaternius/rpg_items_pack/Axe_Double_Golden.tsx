...
export default function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/glb/rpg_items_pack/Axe_Double_Golden.glb') as unknown as GLTFResult
  return (
...
useGLTF.preload('/glb/rpg_items_pack/Axe_Double_Golden.glb')
