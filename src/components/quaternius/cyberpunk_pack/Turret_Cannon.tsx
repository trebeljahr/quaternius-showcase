...
type GLTFResult = GLTF & {
  nodes: {
    Turret_Cannon_Base_1: THREE.Mesh
    Turret_Cannon_Base_2: THREE.Mesh
    Turret_Cannon_Base_3: THREE.Mesh
    Turret_Cannon_Base_4: THREE.Mesh
    Turret_Cannon_Top_1: THREE.Mesh
    Turret_Cannon_Top_2: THREE.Mesh
    Turret_Cannon_Top_3: THREE.Mesh
  }
  materials: {
...
export function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/glb/Turret_Cannon.glb') as unknown as GLTFResult
  return (
...
useGLTF.preload('/Turret_Cannon.glb')
