...
export default function Model(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials, animations } = useGLTF('/glb/easy_enemies_pack/Snake_angry.glb') as unknown as GLTFResult
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      ...
      <group name='Root_Scene'>
        <group name='RootNode'>
          <group name='SnakeArmature' rotation={[-Math.PI / 2, 0, 0]}>
            <primitive object={nodes.Root} />
          </group>
          <group name='Snake' position={[0, 0.02, -0.03]} rotation={[-Math.PI / 2, 0, 0]}>
            <skinnedMesh
              name='Snake_1'
...
useGLTF.preload('/glb/easy_enemies_pack/Snake_angry.glb')
