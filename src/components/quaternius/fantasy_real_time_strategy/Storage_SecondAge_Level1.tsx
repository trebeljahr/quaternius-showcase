  ...
  return (
    <group {...props} dispose={null}>
      <group rotation={[-Math.PI / 2, 0, 0]} scale={100}>
        ...
        <mesh
          geometry={nodes.Storage_SecondAge_Level1_2.geometry}
        ...
        <mesh
          geometry={nodes.Storage_SecondAge_Level1_6.geometry}
          material={materials.Stone_Light}
        />
        <mesh
          geometry={nodes.Storage_SecondAge_Level1_7.geometry}
