...
export default function Model(props: JSX.IntrinsicElements["group"]) {
  const { nodes, materials } = useGLTF(
    "/glb/real_time_strategy_pack/Barracks_FirstAge_Level3.glb",
  ...
  return (
    <group {...props} dispose={null}>
      <group rotation={[-Math.PI / 2, 0, 0]} scale={100}>
        ...
        <mesh
          geometry={nodes.Barracks_FirstAge_Level3_3.geometry}
          material={materials.Wood_Light}
        />
        <mesh
          geometry={nodes.Barracks_FirstAge_Level3_4.geometry}
        ...
        <mesh
          geometry={nodes.Barracks_FirstAge_Level3_7.geometry}
