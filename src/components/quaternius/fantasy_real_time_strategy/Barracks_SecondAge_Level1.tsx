...
export default function Model(props: JSX.IntrinsicElements["group"]) {
  const { nodes, materials } = useGLTF(
    "/glb/real_time_strategy_pack/Barracks_SecondAge_Level1.glb",
  ...
  return (
    <group {...props} dispose={null}>
      <group rotation={[-Math.PI / 2, 0, 0]} scale={100}>
        ...
        <mesh
          geometry={nodes.Barracks_SecondAge_Level1_2.geometry}
        ...
        <mesh
          geometry={nodes.Barracks_SecondAge_Level1_5.geometry}
        ...
        <mesh
          geometry={nodes.Barracks_SecondAge_Level1_8.geometry}
