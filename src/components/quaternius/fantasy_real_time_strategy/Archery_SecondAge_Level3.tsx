  ...
  return (
    <group {...props} dispose={null}>
      <group rotation={[-Math.PI / 2, 0, 0]} scale={100}>
        ...
        <mesh
          geometry={nodes.Archery_SecondAge_Level3_2.geometry}
        ...
        <mesh
          geometry={nodes.Archery_SecondAge_Level3_8.geometry}
          material={materials.Stone_Light}
        />
        <mesh
          geometry={nodes.Archery_SecondAge_Level3_9.geometry}
