...
export default function Model(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials, animations } = useGLTF('/glb/animals_pack/Donkey.glb') as unknown as GLTFResult
    ...
    <group ref={group} {...props} dispose={null}>
      ...
      <group name='Root_Scene'>
        <group name='RootNode'>
          ...
          <group name='Donkey' rotation={[-Math.PI / 2, 0, 0]}>
            <skinnedMesh
              name='Donkey_1'
...
useGLTF.preload('/glb/animals_pack/Donkey.glb')
