      ...
      <group name="Root_Scene">
        <group name="RootNode">
          ...
          <group name="Fox" rotation={[-Math.PI / 2, 0, 0]} scale={100}>
            <skinnedMesh name="Fox_1" geometry={nodes.Fox_1.geometry} material={materials.Main} skeleton={nodes.Fox_1.skeleton} />
            <skinnedMesh name="Fox_2" geometry={nodes.Fox_2.geometry} material={materials.Main_Light} skeleton={nodes.Fox_2.skeleton} />
            <skinnedMesh name="Fox_3" geometry={nodes.Fox_3.geometry} material={materials.Grey} skeleton={nodes.Fox_3.skeleton} />
            <skinnedMesh name="Fox_4" geometry={nodes.Fox_4.geometry} material={materials.Black} skeleton={nodes.Fox_4.skeleton} />
            <skinnedMesh name="Fox_5" geometry={nodes.Fox_5.geometry} material={materials.Eyes} skeleton={nodes.Fox_5.skeleton} />
          </group>
        </group>
      </group>
    </group>
