...
export function Model(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials, animations } = useGLTF('/Horse_White.glb') as GLTFResult
      ...
      <group name="Root_Scene">
        <group name="RootNode">
          ...
          <group name="Horse" rotation={[-Math.PI / 2, 0, 0]} scale={100}>
            ...
            <skinnedMesh name="Horse_3" geometry={nodes.Horse_3.geometry} material={materials.Muzzle} skeleton={nodes.Horse_3.skeleton} />
            <skinnedMesh name="Horse_4" geometry={nodes.Horse_4.geometry} material={materials.Hooves} skeleton={nodes.Horse_4.skeleton} />
            <skinnedMesh name="Horse_5" geometry={nodes.Horse_5.geometry} material={materials.Main_Light} skeleton={nodes.Horse_5.skeleton} />
            <skinnedMesh name="Horse_6" geometry={nodes.Horse_6.geometry} material={materials.Eye_Black} skeleton={nodes.Horse_6.skeleton} />
            <skinnedMesh name="Horse_7" geometry={nodes.Horse_7.geometry} material={materials.Eye_White} skeleton={nodes.Horse_7.skeleton} />
          </group>
        </group>
      </group>
    </group>
...
useGLTF.preload('/Horse_White.glb')
