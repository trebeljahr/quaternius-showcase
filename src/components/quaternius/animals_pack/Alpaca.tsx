...
export function Model(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials, animations } = useGLTF('/Alpaca.glb') as GLTFResult
      ...
      <group name="Root_Scene">
        <group name="RootNode">
          ...
          <group name="Alpaca" rotation={[-Math.PI / 2, 0, 0]} scale={100}>
            <skinnedMesh name="Alpaca_1" geometry={nodes.Alpaca_1.geometry} material={materials.Main_Light} skeleton={nodes.Alpaca_1.skeleton} />
            <skinnedMesh name="Alpaca_2" geometry={nodes.Alpaca_2.geometry} material={materials.Main} skeleton={nodes.Alpaca_2.skeleton} />
            <skinnedMesh name="Alpaca_3" geometry={nodes.Alpaca_3.geometry} material={materials.Main_Dark} skeleton={nodes.Alpaca_3.skeleton} />
            <skinnedMesh name="Alpaca_4" geometry={nodes.Alpaca_4.geometry} material={materials.Muzzle} skeleton={nodes.Alpaca_4.skeleton} />
            <skinnedMesh name="Alpaca_5" geometry={nodes.Alpaca_5.geometry} material={materials.Hooves} skeleton={nodes.Alpaca_5.skeleton} />
            <skinnedMesh name="Alpaca_6" geometry={nodes.Alpaca_6.geometry} material={materials.Eyes_Black} skeleton={nodes.Alpaca_6.skeleton} />
            <skinnedMesh name="Alpaca_7" geometry={nodes.Alpaca_7.geometry} material={materials.Eyes_White} skeleton={nodes.Alpaca_7.skeleton} />
          </group>
        </group>
      </group>
    </group>
