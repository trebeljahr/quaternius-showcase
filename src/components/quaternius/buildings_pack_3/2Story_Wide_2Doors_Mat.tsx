...
export function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/glb/buildings_pack_3/2Story_Wide_2Doors_Mat.glb') as unknown as GLTFResult
  return (
...
useGLTF.preload('/glb/buildings_pack_3/2Story_Wide_2Doors_Mat.glb')
