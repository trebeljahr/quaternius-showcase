      ...
      <div className='fixed inset-0 z-[2000] overflow-y-auto bg-leva-dark text-leva-white font-leva p-8'>
        <div className='max-w-2xl mx-auto'>
          ...
          <p className='text-sm opacity-70 mb-6'>
            ...
            and § 18 (2) MStV (Interstate Media Treaty).
          </p>
          ...
          <section className='mb-6'>
            ...
            <p className='text-sm opacity-80'>
              Email:{' '}
              <a href='mailto:imprint+quaternius@trebeljahr.com' className='text-yellow-400 hover:underline'>
          ...
          <section className='mb-6'>
            ...
            <p className='text-sm leading-relaxed opacity-80'>
              ...
              over whose content I have no influence.
            </p>
          </section>
